...
ADATP5636_TO_DUBLIN_CORE: List[CrosswalkEntry] = [
    ...
    CrosswalkEntry("adatp5636", "dateCreated", "dublin_core", "date", "partial",
                   "DC dc:date is a generic date element. NCMS dateCreated maps most naturally to DC date. "
                   "Use DCTerms:created for a more precise mapping."),
    CrosswalkEntry("adatp5636", "dateIssued", "dublin_core", "date", "partial",
                   "DC dc:date is generic; DCTerms:issued is more precise for the issuance date."),
    CrosswalkEntry("adatp5636", "dateModified", "dublin_core", "date", "partial",
                   "DC dc:date is generic; DCTerms:modified is more precise."),
    CrosswalkEntry("adatp5636", "description", "dublin_core", "description", "exact",
                   "Both provide a textual account of the resource content."),
    CrosswalkEntry("adatp5636", "abstract", "dublin_core", "description", "similar",
                   "NCMS abstract is a more formal summary; DC description is broader."),
    ...
    CrosswalkEntry("adatp5636", "accessRights", "dublin_core", "rights", "partial",
                   "NCMS accessRights is more specific (access control); DC rights is broader."),
    CrosswalkEntry("adatp5636", "contributor", "dublin_core", "contributor", "exact",
                   "Both express contributing agents with secondary roles."),
    ...
    CrosswalkEntry("adatp5636", "license", "dublin_core", "rights", "partial",
                   "NCMS license is more specific (URI to licence); DC rights is broader."),
    CrosswalkEntry("adatp5636", "provenance", "dublin_core", "", "none",
                   "No DC 1.1 equivalent; DCTerms:provenance provides this in the extended terms."),
    CrosswalkEntry("adatp5636", "conformsTo", "dublin_core", "", "none",
                   "No DC 1.1 equivalent; DCTerms:conformsTo provides this."),
    ...
    CrosswalkEntry("adatp5636", "version", "dublin_core", "", "none",
                   "No DC 1.1 equivalent; DCTerms does not have a direct version element."),
    ...
    CrosswalkEntry("adatp5636", "dateDisposition", "dublin_core", "", "none",
                   "Records management concept not present in Dublin Core."),
    CrosswalkEntry("adatp5636", "tableOfContents", "dublin_core", "description", "partial",
                   "NCMS tableOfContents is a specific sub-type of description; DC uses description for all."),
]
...
ADATP5636_TO_DCAT_AP_SE: List[CrosswalkEntry] = [
    ...
    CrosswalkEntry("adatp5636", "isVersionOf",       "dcat_ap_se", "dct:isVersionOf", "exact",
                   "Direct transfer."),
    CrosswalkEntry("adatp5636", "hasPart",           "dcat_ap_se", "dct:isPartOf",    "exact",
                   "Direct transfer."),
